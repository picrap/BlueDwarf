...
namespace BlueDwarf.Net.Proxy.Scanner
{
    ...
    public class ProxyPageProvider
    {
        ...
        public static readonly ProxyPageProvider[] Default = 
        {
            ...
            new ProxyPageProvider(new Uri("http://www.proxynova.com/proxy-server-list/country-au/"), ProxynovaPage + "Australia", false, ProxynovaEx),
            new ProxyPageProvider(new Uri("http://www.proxynova.com/proxy-server-list/country-at/"), ProxynovaPage + "Austria", false, ProxynovaEx),
            ...
            new ProxyPageProvider(new Uri("http://www.proxynova.com/proxy-server-list/country-it/"), ProxynovaPage + "Italy", false, ProxynovaEx),
            ...
            new ProxyPageProvider(new Uri("http://www.proxynova.com/proxy-server-list/country-pt/"), ProxynovaPage + "Portugal", false, ProxynovaEx),
            new ProxyPageProvider(new Uri("http://www.proxynova.com/proxy-server-list/country-ru/"), ProxynovaPage + "Russia", false, ProxynovaEx),
            new ProxyPageProvider(new Uri("http://www.proxynova.com/proxy-server-list/country-es/"), ProxynovaPage + "Spain", false, ProxynovaEx),
            new ProxyPageProvider(new Uri("http://www.proxynova.com/proxy-server-list/country-ch/"), ProxynovaPage + "Switzerland", false, ProxynovaEx),
